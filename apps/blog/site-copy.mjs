...
const siteCopyRegistry = {
  ...
  'visibility-help': {
    ...
    concepts: {
      guide: {
        description:
          'Practical guidance on Generative Engine Optimization for brands that want to be cited and recommended by AI search engines.',
        nav: [{ path: '/', label: 'Articles' }],
        callsToAction: {
          primary: {
            href: 'https://visibility.help',
            label: 'Get started',
          },
          secondary: {
            href: 'mailto:hello@visibility.help',
            label: 'Contact',
          },
        },
        shell: {
          ...
          homeTitle: 'Be the brand AI engines cite when it matters.',
          homeDescription:
            'Visibility helps businesses understand how AI search engines form recommendations and what it takes to earn a place in the answer.',
          homeStats: [],
          homeAsideEyebrow: 'Why this matters',
          homeAsideReasonTitle: 'The shift from links to mentions',
          homeAsideReasonText:
            'As search becomes conversational, being cited inside an AI answer is more valuable than ranking on a traditional results page. These guides show you how to earn that placement.',
          listingEyebrow: 'Articles',
          listingTitle: 'How to earn visibility in AI-driven search',
          listingDescription:
            'Select a guide to learn what influences generative citations, how to structure your presence, and how to measure progress over time.',
          listingEmptyText: 'No articles are published yet.',
          articleContextLabel: 'Guide',
          articleLanguageBadge: 'In English',
          articlePrimaryActionText: 'Read article',
          articleNextStepEyebrow: 'Next step',
          articleNextStepText:
            'Apply the principles from this guide to your own brand presence and track how your visibility evolves in AI responses.',
          articleAboutPurpose: 'Helps businesses earn citations and recommendations from AI search engines.',
          footerEyebrow: 'Visibility',
          footerTitle: 'Build a brand presence that AI engines trust and recommend.',
          footerDescription:
            'Every guide is written for leaders and operators who want to understand generative search and take concrete steps toward being cited where decisions are made.',
          footerOffersLabel: 'Services',
          footerTechnicalLabel: 'Technical',
          footerContactLabel: 'Contact',
          footerCopyright: 'Content written for global business audiences.',
          footerNote: 'Return to the homepage to explore the full approach.',
          contentMeta: {
            authorEyebrow: 'Author',
            articleListingTitle: 'Articles',
            authorEmptyText: 'No articles from this author yet.',
