...
const siteCopyRegistry = {
  ...
  'visibility-help': {
    ...
    concepts: {
      guide: {
        description:
          'Emdash is the AI content engine that generates, optimizes, and publishes SEO-ready articles to your website. Stop writing from scratch. Start publishing.',
        nav: [
          { path: '/', label: 'Product' },
        ...
        shell: {
          subLabel: 'Guide',
          homeEyebrow: 'AI Content Engine',
          homeTitle: 'Your website writes itself while you sleep.',
          homeDescription:
            'Emdash generates SEO-ready articles, structures them for AI search engines, and publishes them to your site. You review. You click approve. Done.',
          homeStats: [
            { value: '10x', label: 'Faster publishing' },
            { value: '100%', label: 'SEO optimized' },
            { value: '24h', label: 'From idea to live' },
          ],
          homeAsideEyebrow: 'Why Emdash',
          homeAsideReasonTitle: 'Content is your moat. Speed is your weapon.',
          homeAsideReasonText:
            'The teams winning in AI search are publishing 10x more content than their competitors. Emdash lets you do that without hiring a full editorial team.',
          listingEyebrow: 'Resources',
          listingTitle: 'Learn how to turn your site into a content machine',
          listingDescription:
            'Guides on AI content generation, GEO optimization, and setting up the Emdash sidecar for your website.',
          ...
          articleNextStepEyebrow: 'Next step',
          articleNextStepText:
            'Apply these principles in your Emdash dashboard and start generating content that ranks.',
          articleAboutPurpose: 'Helps you get more from your content engine.',
          footerEyebrow: 'Emdash',
          footerTitle: 'Stop writing. Start publishing.',
          footerDescription:
            'Emdash is the AI content engine for teams that want to dominate search without expanding their headcount. Generate, optimize, publish. All in one place.',
          footerOffersLabel: 'Product',
          footerTechnicalLabel: 'Developers',
          footerContactLabel: 'Contact',
          footerCopyright: 'Emdash — AI content engine.',
          footerNote: 'Built for teams that publish.',
          contentMeta: {
            authorEyebrow: 'Author',
            articleListingTitle: 'Articles',
            authorEmptyText: 'No articles from this author yet.',
