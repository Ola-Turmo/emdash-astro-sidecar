const siteProfiles = {
  'kurs-ing': {
    ...
    concepts: {
      guide: {
        ...
        quality: {
          dashboardLabel: 'Kurs.ing guide',
          flagshipUrls: [
            'https://www.kurs.ing/guide/',
            'https://www.kurs.ing/guide/blog/salgsbevilling-pensum-og-vanlige-feil/',
          ],
          fieldTargets: {
            release: {
              LCP: 2500,
      ...
      kommune: {
        ...
        quality: {
          dashboardLabel: 'Kurs.ing kommune',
          flagshipUrls: [
            'https://www.kurs.ing/kommune/',
            'https://www.kurs.ing/kommune/arendal/',
            'https://www.kurs.ing/kommune/trysil/',
          ],
          fieldTargets: {
  ...
  'gatareba-ge': {
    ...
    concepts: {
      guide: {
        ...
        quality: {
          dashboardLabel: 'Gatareba.ge guide',
          flagshipUrls: ['https://www.gatareba.ge/guide/'],
          fieldTargets: {
            release: {
              LCP: 2500,
              INP: 200,
  ...
  'visibility-help': {
    ...
    rootRouting: {
      rootOrigin: 'https://visibility.help',
      requiredMarkers: [],
      forbiddenMarkers: [],
      exactBypassPaths: ['/robots.txt', '/sitemap.xml', '/sitemap-index.xml'],
    },
    ...
    concepts: {
      guide: {
        ...
        siteName: 'Visibility',
        shellKey: 'visibility-help/guide',
        routes: {
          articlePrefix: '/blog',
          categoryPrefix: '/category',
          authorPrefix: '/author',
        ...
        quality: {
          dashboardLabel: 'Visibility guide',
